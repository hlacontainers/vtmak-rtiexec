...
Next, build the RTI Executable container image with:
...
Next, build the **skeleton** RTI Exec container image with:

````
docker-compose -f build.yml build
````

### Run skeleton RTI Exec container
